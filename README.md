...
2.   State Management: Zustand (自定義 Hook useStore.jsx)
  
3.   Validation: Zod (Schema-based validation)
  
4.   Styling: Tailwind CSS

5.   Icons/Assets: 自定義圖片按鈕與選單圖標

## 核心功能與修正重點

* 智慧型連動驗證 (Smart Conditional Validation)
